...
function chooseStory() {
    ...
    articleLink = "https://katiebumatay.github.io/CapstoneDevelopment/Final/variables/" + sec + "/" + phraseNum + "/" + v + "/text.html";
    $(".articleText").load(articleLink);
    captionLink = "https://katiebumatay.github.io/CapstoneDevelopment/Final/variables/" + sec + "/" + phraseNum + "/" + v + "/text.html p:first-child";
