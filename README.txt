...
Dev 3: got rid of scroll and implemented position: sticky in css for scrolling, which required making the section height longer so the position stuck for longer as well as giving the sticky elements some margins (top/bottom)