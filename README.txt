...
Dev 11: tried to optimize by using transform translate instead of recalculating top and left -- struggle bc can't do 2 separate transforms on same element (3/19 went back to dev9) --> deleted folder and reduplicated dev9 to dev11 (3/20) --> Successfully changed image and phrase variable placement to transform translate.